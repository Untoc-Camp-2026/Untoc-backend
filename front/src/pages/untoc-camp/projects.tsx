...
import webebebImg from '../../assets/images/webebeb.png';
...
const PROJECT_DATA = [
  ...
  { id: 2, term: '26-1', title: '프로젝트 2', subtitle: '설명 2', imgUrl: 'bg-[#EED270]', topic: '주제 2', leader: '리더', members: '팀원들', description: '설명' },
  { id: 3, term: '26-1', title: '프로젝트 3', subtitle: '설명 3', imgUrl: 'bg-[#F2E774]', topic: '주제 3', leader: '리더', members: '팀원들', description: '설명' },
  { id: 4, term: '26-1', title: '프로젝트 4', subtitle: '설명 4', imgUrl: 'bg-[#F5E2C8]', topic: '주제 4', leader: '리더', members: '팀원들', description: '설명' },
  { id: 5, term: '26-1', title: '프로젝트 5', subtitle: '설명 5', imgUrl: 'bg-[#E3C8F5]', topic: '주제 5', leader: '리더', members: '팀원들', description: '설명' },
  { id: 6, term: '26-1', title: '프로젝트 6', subtitle: '설명 6', imgUrl: 'bg-[#C8F5D8]', topic: '주제 6', leader: '리더', members: '팀원들', description: '설명' },
];
